/* ==========================================================
   ...
   ----------------------------------------------------------
   ✅ تصحيح مهم: هذا السكربت "يفك" disabled من زر nextBtn تلقائياً
   حتى لو كان مكتوب disabled داخل index.html
   ========================================================== */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // إذا عناصر ناقصة: نعرض رسالة داخل الصفحة بدل ما يوقف بصمت
...
#nextBtn
  ...
  // ✅ مهم: فك disabled لو كان موجود في HTML
  ...
  function renderQuestion() {
    ...
    // ✅ فك disabled دائمًا (حتى لو تغيّر من HTML)
    btnNext.removeAttribute("disabled");

    // زر التالي ممنوع قبل الإجابة
